$(document).ready(function($) {
	...
	$.getJSON( rssURL, function foo(data) {
		...
		$.each(data, function (i, post) {
		    ...
		    $('.bloggers').append('<tr class="clickable-row" data-href="'+post.link[0]+'" style="cursor:pointer"><td>'+post.title[0]+'</td><td><span class="text-muted"><small><small>'+date+'</small></small><br></span><span class="label label-default">'+post.rssName+'</span></td></tr>');
		});
